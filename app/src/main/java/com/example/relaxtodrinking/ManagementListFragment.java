...
public class ManagementListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        activity.setTitle("後台管理");
        return inflater.inflate(R.layout.fragment_management_list, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝點擊商品管理＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝//
        btProductList_ManagementList = view.findViewById(R.id.btProductList_ManagementList);
        ...
        //＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝點擊員工管理＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝//
        btEmployeeManagement_ManagementList = view.findViewById(R.id.btEmployeeManagement_ManagementList);
        ...
        //＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝點擊最新消息管理＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝//
        btNewsList_ManagementList = view.findViewById(R.id.btNewsList_ManagementList);
        ...
        //＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝點擊店家資訊管理＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝//
        btStoreManagement_ManagementList = view.findViewById(R.id.btStoreManagement_ManagementList);
        ...
        //＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝點擊登出＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝//
        btLoginOut_ManagementList = view.findViewById(R.id.btLoginOut_ManagementList);
        btLoginOut_ManagementList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                auth.signOut();
